...
public class PerformanceFestivalDTO {
	...
	public String toString() {
		return "PerformanceFestivalDTO [mt20id=" + mt20id + ", prfnm=" + prfnm + ", prfpdfrom=" + prfpdfrom
				+ ", prfpdto=" + prfpdto + ", fcltynm=" + fcltynm + ", poster=" + poster + ", genrenm=" + genrenm
				+ ", prfstate=" + prfstate + ", festival=" + festival + "]";
	}
