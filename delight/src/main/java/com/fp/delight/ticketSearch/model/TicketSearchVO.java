...
public class TicketSearchVO {
	...
	private List<JSONObject> styurls; //소개이미지목록
	...
	public List<JSONObject> getStyurls() {
		return styurls;
	}
	public void setStyurls(List<JSONObject> styurls) {
		this.styurls = styurls;
	}
	@Override
	public String toString() {
		return "TicketSearchVO [mt20id=" + mt20id + ", mt10id=" + mt10id + ", prfnm=" + prfnm + ", prfpdfrom="
				...
				+ ", prfstate=" + prfstate + ", openrun=" + openrun + ", styurls=" + styurls + ", dtguidance="
				+ dtguidance + "]";
	}
