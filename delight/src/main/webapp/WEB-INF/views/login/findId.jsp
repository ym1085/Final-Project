			...
			<div class="item agileits-w3layouts">
				<div class="block text main-agileits" style="background: RGB(0,0,0,0.6)">
					...
					<div class="login-form loginw3-agile">
						<div class="agile-row">
							<h1 style="color: rgb(238,15,116);">아이디 찾기</h1>
							<div class="login-agileits-top">
								
								<!-- form <-> action -->
								<form action="<c:url value = '/login/findId.do'/>" method="post" name = "frm">
									<p>이름</p>
									...
									<ul style="margin: 3%; font-weight: bold;">
										<li>회원가입 시 등록하신 실명을 입력해 주시기 바랍니다.</li>
										<li>회원가입 시 등록하신 이메일을 입력해주시기 바랍니다.</li>
									</ul>
